...
namespace ft
{
	...
	random_access_iterator<Iterator> operator-(const typename random_access_iterator<Iterator>::difference_type & n, const random_access_iterator<Iterator> & it)
		{ return it - n; }
	template<class IteratorL, class IteratorR>
	typename random_access_iterator<IteratorL>::difference_type operator+(const random_access_iterator<IteratorL> & lhs, const random_access_iterator<IteratorR> & rhs)
		{ return lhs.base() + rhs.base(); }
	...
	template<class IteratorL, class IteratorR>
	bool operator==(const random_access_iterator<IteratorL> & lhs, const random_access_iterator<IteratorR> & rhs)	{ return lhs.base() == rhs.base(); }
	template<class IteratorL, class IteratorR>
	bool operator!=(const random_access_iterator<IteratorL> & lhs, const random_access_iterator<IteratorR> & rhs)	{ return lhs.base() != rhs.base(); }
	template<class IteratorL, class IteratorR>
	bool operator<(const random_access_iterator<IteratorL> & lhs, const random_access_iterator<IteratorR> & rhs)	{ return lhs.base() < rhs.base(); }
	...
	class reverse_iterator
	{
		...
		public :
			...
			iterator& operator=(const iterator & other)	{ _ptr = other._ptr; return *this; }
	...
	template<class Iterator>
	reverse_iterator<Iterator> operator-(const typename reverse_iterator<Iterator>::difference_type& n, const reverse_iterator<Iterator>& rhs)
		{ return  rhs.base() + n; }
	template<class IteratorL, class IteratorR>
	typename reverse_iterator<IteratorL>::difference_type operator+(const reverse_iterator<IteratorL> & lhs, const reverse_iterator<IteratorR> & rhs)
		{ return rhs.base() + lhs.base(); }
